...
<section class="page-section">
    <div class="container">
        <div class="product-item">
            ...
            <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="assets/img/3.jpg" alt="..." />
...
<section class="page-section">
    <div class="container">
        <div class="product-item">
            ...
            <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="{{ asset('frontend/assets/img/2.jpg') }}" alt="..." />
...
<section class="page-section">
    <div class="container">
        <div class="product-item">
            ...
            <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="{{ asset('frontend/assets/img/1.jpg') }}" alt="..." />
            <div class="product-item-description d-flex me-auto">
