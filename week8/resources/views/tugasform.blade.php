...
<form action="{{ url('tugashasil') }}" method="POST">
    ...
    <div class="form-group row">
      ...
      <div class="col-8">
        ...
        <div class="custom-control custom-checkbox custom-control-inline">
          <input name="skill" id="skill_5" type="checkbox" class="custom-control-input" value="mysql">
          <label for="skill_5" class="custom-control-label">MySQL</label>
        </div>
        <div class="custom-control custom-checkbox custom-control-inline">
          <input name="skill" id="skill_6" type="checkbox" class="custom-control-input" value="laravel">
          <label for="skill_6" class="custom-control-label">Laravel</label>
        </div>
      </div>
    </div>
    <div class="form-group row">
